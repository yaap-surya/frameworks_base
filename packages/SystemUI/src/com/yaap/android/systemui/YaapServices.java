...
@SysUISingleton
public class YaapServices extends VendorServices {
    ...
    @Inject
    public YaapServices(Context context, UiEventLogger uiEventLogger, AlarmManager alarmManager, StatusBar statusBar) {
        super(context);
