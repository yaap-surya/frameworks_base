...
public class KeyguardSliceProviderYaap extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderYaap> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderYaap keyguardSliceProviderYaap, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderYaap);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderYaap.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderYaap keyguardSliceProviderYaap;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderYaap = (KeyguardSliceProviderYaap) mProviderReference.get();
            }
            if (keyguardSliceProviderYaap != null) {
                keyguardSliceProviderYaap.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderYaap#onBindSlice");
        Slice slice;
